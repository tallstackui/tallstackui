        ...
        <div @class($customize['wrapper.second'])>
            <div x-show="show"
                ...
                <div @class($customize['buttons.wrapper'])>
                    <div x-show="dialog.type === 'question'">
                        <button type="button" @class($customize['buttons.cancel']) x-on:click="reject(dialog)" x-text="dialog.options?.cancel.text"></button>
                    </div>
                    <button @class($customize['buttons.confirm']) x-bind:class="{
                        ...
                        }" x-on:click="accept(dialog)" x-text="dialog.type === 'question' ? dialog.options?.confirm.text : text.ok"></button>
                </div>
            </div>
        </div>
    </div>
