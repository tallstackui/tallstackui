...
| round             | bool\|string            | null    | Applies rounded corners to images and overlay. As a flag it applies `rounded-xl`; as a string it accepts `xs`, `sm`, `md`, `lg`, `xl`, `2xl`, `3xl` or `full` (`rounded-{suffix}`). Any other value throws.                                                                                                                                                |
