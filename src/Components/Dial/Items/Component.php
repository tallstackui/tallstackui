    ...
    public function customization(): array
    {
        return Arr::dot([
            ...
            'item' => [
                ...
                'default' => 'bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-800 dark:bg-dark-700 dark:text-dark-300 dark:hover:bg-dark-600 dark:hover:text-dark-200',
                'bordered' => 'border',
            ],
            'label' => [
