    ...
    public function customization(): array
    {
        return Arr::dot([
            'wrapper' => [
                ...
                'fourth' => 'dark:bg-dark-800 relative flex w-full transform flex-col rounded-t-xl sm:rounded-xl bg-white text-left shadow-xl transition-all',
            ...
            'positions' => [
                ...
                'center-md' => 'items-end md:items-center',
                'center-lg' => 'items-end lg:items-center',
                'center-xl' => 'items-end xl:items-center',
                'center-2xl' => 'items-end 2xl:items-center',
            ],
            'blur' => [
                'sm' => 'backdrop-blur-sm',
                'md' => 'backdrop-blur-md',
            ...
            'title' => [
                'wrapper' => 'dark:border-b-dark-700 flex items-center justify-between border-b border-b-gray-100 px-4 py-2.5',
            ...
            'footer' => [
                'wrapper' => 'dark:text-dark-300 dark:border-t-dark-700 rounded-b-xl border-t border-t-gray-100 p-4 text-gray-700',
                'scrollable' => 'sticky bottom-0 z-10 bg-white dark:bg-dark-800',
                'base' => 'flex gap-2',
                'start' => 'justify-start',
