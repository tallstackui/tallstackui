    ...
    public function customization(): array
    {
        return Arr::dot([
            ...
            'line' => [
                ...
                'border' => 'border-primary-100 dark:border-dark-700 w-full border-t',
                'base' => 'dark:bg-dark-800 text-primary-600 dark:text-dark-100 bg-white px-3 text-base font-semibold whitespace-nowrap overflow-hidden transition-all duration-150',
                'base.visible' => 'opacity-100 max-w-48',
                'base.hidden' => 'opacity-0 max-w-0',
            ],
            'line-right' => [
