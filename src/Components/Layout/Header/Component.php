...
class Component extends TallStackUiComponent implements Customization
{
    ...
    {
        return Arr::dot([
            'wrapper' => 'dark:bg-dark-800 dark:border-dark-600 sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 sm:gap-x-6 sm:px-6 lg:px-8 tsui-scrollbar-bleed',
            'button' => [
