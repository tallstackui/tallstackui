...
class Component extends TallStackUiComponent implements Customization
{
    ...
    public function customization(): array
    {
        return Arr::dot([
            ...
            'item' => [
                'base' => 'text-gray-600 dark:hover:bg-dark-700 dark:text-dark-300 dark:focus:bg-dark-700 flex w-full cursor-pointer items-center justify-between whitespace-nowrap transition-colors duration-150 hover:bg-gray-100 focus:bg-gray-100 focus:outline-hidden',
                'sizes' => [
            ...
            'floating' => [
                ...
                'widths' => [
                    ...
                    'sm' => "data-[tsui-dropdown-width='sm']:min-w-48",
                    'md' => "data-[tsui-dropdown-width='md']:min-w-56",
                    'lg' => "data-[tsui-dropdown-width='lg']:min-w-64",
                    'xl' => "data-[tsui-dropdown-width='xl']:min-w-72",
                    '2xl' => "data-[tsui-dropdown-width='2xl']:min-w-80",
                ],
            ],
