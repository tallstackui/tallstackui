    ...
    public function customization(): array
    {
        return Arr::dot([
            'item' => [
                ...
                'trigger' => [
                    'base' => 'flex w-full items-center gap-3 px-4 py-3 text-start text-sm font-medium justify-between transition-colors hover:bg-gray-50 dark:hover:bg-dark-600',
