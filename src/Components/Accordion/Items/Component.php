...
class Component extends TallStackUiComponent implements Customization
{
    ...
    public function customization(): array
    {
        return Arr::dot([
            'item' => [
                'wrapper' => 'border-b border-gray-200 dark:border-dark-700 last:border-b-0',
                'trigger' => [
                    'base' => 'flex w-full cursor-pointer items-center gap-3 px-4 py-3 text-start text-sm font-medium justify-between transition-colors hover:bg-gray-50 dark:hover:bg-dark-700',
                    'open' => 'text-primary-600 dark:text-primary-400',
                    'closed' => 'text-gray-700 dark:text-dark-300',
                ],
                'content' => 'px-4 pb-4 text-sm text-gray-600 dark:text-dark-400',
                'icon' => [
