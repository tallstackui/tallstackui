...
class Component extends TallStackUiComponent implements Customization
{
    ...
    public function customization(): array
    {
        return Arr::dot([
            'wrapper' => [
                'class' => 'inline-flex items-center justify-center rounded-md border font-mono font-medium shadow bg-gray-100 border-gray-200 text-gray-600 dark:bg-dark-800 dark:border-dark-700 dark:text-dark-300',
                'sizes' => [
