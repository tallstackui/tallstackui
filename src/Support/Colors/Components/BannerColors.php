...
class BannerColors
{
    ...
    private function background(): array
    {
        return [
            'solid' => [
                'black' => 'bg-black',
                'primary' => 'bg-primary-600 dark:bg-primary-600/70',
                'secondary' => 'bg-secondary-600 dark:bg-secondary-600/70',
                ...
                'mauve' => 'bg-mauve-600 dark:bg-mauve-600/70',
                'olive' => 'bg-olive-600 dark:bg-olive-600/70',
                'mist' => 'bg-mist-600 dark:bg-mist-600/70',
                'taupe' => 'bg-taupe-600 dark:bg-taupe-600/70',
            ],
            'light' => [
                'black' => 'bg-black/70',
                'primary' => 'bg-primary-300 dark:bg-primary-600/30',
                'secondary' => 'bg-secondary-300 dark:bg-secondary-600/30',
                'slate' => 'bg-slate-300 dark:bg-slate-600/30',
                'gray' => 'bg-gray-300 dark:bg-gray-600/30',
                'zinc' => 'bg-zinc-300 dark:bg-zinc-600/30',
                'neutral' => 'bg-neutral-300 dark:bg-neutral-600/30',
                'stone' => 'bg-stone-300 dark:bg-stone-600/30',
                'red' => 'bg-red-300 dark:bg-red-600/30',
                'orange' => 'bg-orange-300 dark:bg-orange-600/30',
                'amber' => 'bg-amber-300 dark:bg-amber-600/30',
                'yellow' => 'bg-yellow-300 dark:bg-yellow-600/30',
                'lime' => 'bg-lime-300 dark:bg-lime-600/30',
                'green' => 'bg-green-300 dark:bg-green-600/30',
                'emerald' => 'bg-emerald-300 dark:bg-emerald-600/30',
                'teal' => 'bg-teal-300 dark:bg-teal-600/30',
                'cyan' => 'bg-cyan-300 dark:bg-cyan-600/30',
                'sky' => 'bg-sky-300 dark:bg-sky-600/30',
                'blue' => 'bg-blue-300 dark:bg-blue-600/30',
                'indigo' => 'bg-indigo-300 dark:bg-indigo-600/30',
                'violet' => 'bg-violet-300 dark:bg-violet-600/30',
                'purple' => 'bg-purple-300 dark:bg-purple-600/30',
                'fuchsia' => 'bg-fuchsia-300 dark:bg-fuchsia-600/30',
                'pink' => 'bg-pink-300 dark:bg-pink-600/30',
                'rose' => 'bg-rose-300 dark:bg-rose-600/30',
                'mauve' => 'bg-mauve-300 dark:bg-mauve-600/30',
                'olive' => 'bg-olive-300 dark:bg-olive-600/30',
                'mist' => 'bg-mist-300 dark:bg-mist-600/30',
                'taupe' => 'bg-taupe-300 dark:bg-taupe-600/30',
            ],
        ];
    }
