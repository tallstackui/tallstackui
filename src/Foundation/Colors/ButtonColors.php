...
class ButtonColors
{
    ...
    private function background(): array
    {
        return [
            ...
            'flat' => [
                'white' => 'focus:ring-offset-background-white text-white hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-white hover:bg-white dark:hover:text-white dark:hover:bg-white focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-white focus:bg-white focus:ring-white dark:focus:text-white dark:focus:bg-white dark:focus:ring-white',
                'black' => 'focus:ring-offset-background-white text-black hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-black hover:bg-black-400 dark:hover:text-black dark:hover:bg-black focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-black focus:bg-black focus:ring-black dark:focus:text-black dark:focus:bg-black dark:focus:ring-black',
                'primary' => 'focus:ring-offset-background-white text-primary-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-primary-700 hover:bg-primary-400 dark:hover:text-primary-500 dark:hover:bg-primary-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-primary-700 focus:bg-primary-400 focus:ring-primary-600 dark:focus:text-primary-500 dark:focus:bg-primary-600 dark:focus:ring-primary-700',
                'secondary' => 'focus:ring-offset-background-white text-secondary-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-secondary-700 hover:bg-secondary-400 dark:hover:text-secondary-500 dark:hover:bg-secondary-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-secondary-700 focus:bg-secondary-400 focus:ring-secondary-600 dark:focus:text-secondary-500 dark:focus:bg-secondary-600 dark:focus:ring-secondary-700',
                'slate' => 'focus:ring-offset-background-white text-slate-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-slate-700 hover:bg-slate-400 dark:hover:text-slate-500 dark:hover:bg-slate-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-slate-700 focus:bg-slate-400 focus:ring-slate-600 dark:focus:text-slate-500 dark:focus:bg-slate-600 dark:focus:ring-slate-700',
                'gray' => 'focus:ring-offset-background-white text-gray-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-gray-700 hover:bg-gray-400 dark:hover:text-gray-500 dark:hover:bg-gray-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-gray-700 focus:bg-gray-400 focus:ring-gray-600 dark:focus:text-gray-500 dark:focus:bg-gray-600 dark:focus:ring-gray-700',
                'zinc' => 'focus:ring-offset-background-white text-zinc-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-zinc-700 hover:bg-zinc-400 dark:hover:text-zinc-500 dark:hover:bg-zinc-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-zinc-700 focus:bg-zinc-400 focus:ring-zinc-600 dark:focus:text-zinc-500 dark:focus:bg-zinc-600 dark:focus:ring-zinc-700',
                'neutral' => 'focus:ring-offset-background-white text-neutral-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-neutral-700 hover:bg-neutral-400 dark:hover:text-neutral-500 dark:hover:bg-neutral-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-neutral-700 focus:bg-neutral-400 focus:ring-neutral-600 dark:focus:text-neutral-500 dark:focus:bg-neutral-600 dark:focus:ring-neutral-700',
                'stone' => 'focus:ring-offset-background-white text-stone-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-stone-700 hover:bg-stone-400 dark:hover:text-stone-500 dark:hover:bg-stone-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-stone-700 focus:bg-stone-400 focus:ring-stone-600 dark:focus:text-stone-500 dark:focus:bg-stone-600 dark:focus:ring-stone-700',
                'red' => 'focus:ring-offset-background-white text-red-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-red-700 hover:bg-red-400 dark:hover:text-red-500 dark:hover:bg-red-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-red-700 focus:bg-red-400 focus:ring-red-600 dark:focus:text-red-500 dark:focus:bg-red-600 dark:focus:ring-red-700',
                'orange' => 'focus:ring-offset-background-white text-orange-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-orange-700 hover:bg-orange-400 dark:hover:text-orange-500 dark:hover:bg-orange-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-orange-700 focus:bg-orange-400 focus:ring-orange-600 dark:focus:text-orange-500 dark:focus:bg-orange-600 dark:focus:ring-orange-700',
                'amber' => 'focus:ring-offset-background-white text-amber-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-amber-700 hover:bg-amber-400 dark:hover:text-amber-500 dark:hover:bg-amber-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-amber-700 focus:bg-amber-400 focus:ring-amber-600 dark:focus:text-amber-500 dark:focus:bg-amber-600 dark:focus:ring-amber-700',
                'yellow' => 'focus:ring-offset-background-white text-yellow-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-yellow-700 hover:bg-yellow-400 dark:hover:text-yellow-500 dark:hover:bg-yellow-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-yellow-700 focus:bg-yellow-400 focus:ring-yellow-600 dark:focus:text-yellow-500 dark:focus:bg-yellow-600 dark:focus:ring-yellow-700',
                'lime' => 'focus:ring-offset-background-white text-lime-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-lime-700 hover:bg-lime-400 dark:hover:text-lime-500 dark:hover:bg-lime-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-lime-700 focus:bg-lime-400 focus:ring-lime-600 dark:focus:text-lime-500 dark:focus:bg-lime-600 dark:focus:ring-lime-700',
                'green' => 'focus:ring-offset-background-white text-green-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-green-700 hover:bg-green-400 dark:hover:text-green-500 dark:hover:bg-green-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-green-700 focus:bg-green-400 focus:ring-green-600 dark:focus:text-green-500 dark:focus:bg-green-600 dark:focus:ring-green-700',
                'emerald' => 'focus:ring-offset-background-white text-emerald-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-emerald-700 hover:bg-emerald-400 dark:hover:text-emerald-500 dark:hover:bg-emerald-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-emerald-700 focus:bg-emerald-400 focus:ring-emerald-600 dark:focus:text-emerald-500 dark:focus:bg-emerald-600 dark:focus:ring-emerald-700',
                'teal' => 'focus:ring-offset-background-white text-teal-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-teal-700 hover:bg-teal-400 dark:hover:text-teal-500 dark:hover:bg-teal-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-teal-700 focus:bg-teal-400 focus:ring-teal-600 dark:focus:text-teal-500 dark:focus:bg-teal-600 dark:focus:ring-teal-700',
                'cyan' => 'focus:ring-offset-background-white text-cyan-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-cyan-700 hover:bg-cyan-400 dark:hover:text-cyan-500 dark:hover:bg-cyan-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-cyan-700 focus:bg-cyan-400 focus:ring-cyan-600 dark:focus:text-cyan-500 dark:focus:bg-cyan-600 dark:focus:ring-cyan-700',
                'sky' => 'focus:ring-offset-background-white text-sky-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-sky-700 hover:bg-sky-400 dark:hover:text-sky-500 dark:hover:bg-sky-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-sky-700 focus:bg-sky-400 focus:ring-sky-600 dark:focus:text-sky-500 dark:focus:bg-sky-600 dark:focus:ring-sky-700',
                'blue' => 'focus:ring-offset-background-white text-blue-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-blue-700 hover:bg-blue-400 dark:hover:text-blue-500 dark:hover:bg-blue-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-blue-700 focus:bg-blue-400 focus:ring-blue-600 dark:focus:text-blue-500 dark:focus:bg-blue-600 dark:focus:ring-blue-700',
                'indigo' => 'focus:ring-offset-background-white text-indigo-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-indigo-700 hover:bg-indigo-400 dark:hover:text-indigo-500 dark:hover:bg-indigo-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-indigo-700 focus:bg-indigo-400 focus:ring-indigo-600 dark:focus:text-indigo-500 dark:focus:bg-indigo-600 dark:focus:ring-indigo-700',
                'violet' => 'focus:ring-offset-background-white text-violet-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-violet-700 hover:bg-violet-400 dark:hover:text-violet-500 dark:hover:bg-violet-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-violet-700 focus:bg-violet-400 focus:ring-violet-600 dark:focus:text-violet-500 dark:focus:bg-violet-600 dark:focus:ring-violet-700',
                'purple' => 'focus:ring-offset-background-white text-purple-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-purple-700 hover:bg-purple-400 dark:hover:text-purple-500 dark:hover:bg-purple-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-purple-700 focus:bg-purple-400 focus:ring-purple-600 dark:focus:text-purple-500 dark:focus:bg-purple-600 dark:focus:ring-purple-700',
                'fuchsia' => 'focus:ring-offset-background-white text-fuchsia-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-fuchsia-700 hover:bg-fuchsia-400 dark:hover:text-fuchsia-500 dark:hover:bg-fuchsia-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-fuchsia-700 focus:bg-fuchsia-400 focus:ring-fuchsia-600 dark:focus:text-fuchsia-500 dark:focus:bg-fuchsia-600 dark:focus:ring-fuchsia-700',
                'pink' => 'focus:ring-offset-background-white text-pink-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-pink-700 hover:bg-pink-400 dark:hover:text-pink-500 dark:hover:bg-pink-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-pink-700 focus:bg-pink-400 focus:ring-pink-600 dark:focus:text-pink-500 dark:focus:bg-pink-600 dark:focus:ring-pink-700',
                'rose' => 'focus:ring-offset-background-white text-rose-600 hover:bg-opacity-25 dark:hover:bg-opacity-15 hover:text-rose-700 hover:bg-rose-400 dark:hover:text-rose-500 dark:hover:bg-rose-600 focus:bg-opacity-25 dark:focus:bg-opacity-15 focus:ring-offset-0 focus:text-rose-700 focus:bg-rose-400 focus:ring-rose-600 dark:focus:text-rose-500 dark:focus:bg-rose-600 dark:focus:ring-rose-700',
            ],
        ];
    }
