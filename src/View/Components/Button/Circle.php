...
class Circle extends TallStackUiComponent implements Personalization
{
    ...
    public function personalization(): array
    {
        return Arr::dot([
            'wrapper' => [
                'base' => 'focus:ring-offset-white focus:shadow-outline group inline-flex items-center justify-center rounded-full gap-x-2 border text-sm outline-hidden transition-all duration-200 ease-in-out hover:shadow-sm hover:shadow-xs focus:border-transparent focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50',
                'sizes' => [
                    'xs' => 'w-4 h-4',
                    'sm' => 'w-6 h-6',
                    'md' => 'w-9 h-9',
