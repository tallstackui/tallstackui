...
trait DefaultInputClasses
{
    ...
    {
        return [
            'wrapper' => 'focus:ring-primary-600 focus-within:focus:ring-primary-600 focus-within:ring-primary-600 dark:focus-within:ring-primary-600 flex rounded-md px-2 ring-1 ring-inset transition focus-within:ring-2 focus-within:ring-inset focus:ring-gray-300',
