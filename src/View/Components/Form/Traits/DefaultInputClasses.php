...
trait DefaultInputClasses
{
    ...
    private function input(): array
    {
        return [
            ...
            'base' => 'dark:placeholder-dark-400 w-full rounded-md border-0 bg-transparent py-1.5 ring-0 ring-inset placeholder:text-gray-400 focus:outline-none focus:ring-transparent sm:text-sm sm:leading-6',
