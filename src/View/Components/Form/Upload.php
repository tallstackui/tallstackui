...
class Upload extends BaseComponent implements Personalization
{
    ...
    public function personalization(): array
    {
        return Arr::dot([
            ...
            'placeholder' => [
                'input' => 'absolute inset-0 z-50 h-20 w-full opacity-0 outline-none',
                'wrapper' => 'dark:border-dark-500 dark:bg-dark-700 dark:hover:bg-dark-600 flex h-14 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 transition hover:bg-gray-100',
