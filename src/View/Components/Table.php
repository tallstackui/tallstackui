    ...
    public function personalization(): array
    {
        return Arr::dot([
            ...
            'subTable' => [
                ...
                'expandButton' => 'text-gray-500 dark:text-dark-300 hover:text-gray-700 dark:hover:text-dark-100 transition-transform duration-200',
