    ...
    private function background(): array
    {
        return [
            'solid' => [
                ...
                'slate' => 'text-slate-50 border-slate-500 ring-slate-500 bg-slate-500 focus:bg-slate-600 hover:bg-slate-600 dark:focus:ring-offset-dark-900 dark:focus:ring-slate-600 dark:hover:bg-slate-600 dark:hover:ring-slate-600 hover:border-transparent focus:ring-offset-2',
                'gray' => 'text-gray-50 border-gray-500 ring-gray-500 bg-gray-500 focus:bg-gray-600 hover:bg-gray-600 dark:focus:ring-offset-dark-900 dark:focus:ring-gray-600 dark:hover:bg-gray-600 dark:hover:ring-gray-600 hover:border-transparent focus:ring-offset-2',
                'zinc' => 'text-zinc-50 border-zinc-500 ring-zinc-500 bg-zinc-500 focus:bg-zinc-600 hover:bg-zinc-600 dark:focus:ring-offset-dark-900 dark:focus:ring-zinc-600 dark:hover:bg-zinc-600 dark:hover:ring-zinc-600 hover:border-transparent focus:ring-offset-2',
                'neutral' => 'text-neutral-50 border-neutral-500 ring-neutral-500 bg-neutral-500 focus:bg-neutral-600 hover:bg-neutral-600 dark:focus:ring-offset-dark-900 dark:focus:ring-neutral-600 dark:hover:bg-neutral-600 dark:hover:ring-neutral-600 hover:border-transparent focus:ring-offset-2',
                'stone' => 'text-stone-50 border-stone-500 ring-stone-500 bg-stone-500 focus:bg-stone-600 hover:bg-stone-600 dark:focus:ring-offset-dark-900 dark:focus:ring-stone-600 dark:hover:bg-stone-600 dark:hover:ring-stone-600 hover:border-transparent focus:ring-offset-2',
                'red' => 'text-red-50 border-red-500 ring-red-500 bg-red-500 focus:bg-red-600 hover:bg-red-600 dark:focus:ring-offset-dark-900 dark:focus:ring-red-600 dark:hover:bg-red-600 dark:hover:ring-red-600 hover:border-transparent focus:ring-offset-2',
                'orange' => 'text-orange-50 border-orange-500 ring-orange-500 bg-orange-500 focus:bg-orange-600 hover:bg-orange-600 dark:focus:ring-offset-dark-900 dark:focus:ring-orange-600 dark:hover:bg-orange-600 dark:hover:ring-orange-600 hover:border-transparent focus:ring-offset-2',
                'amber' => 'text-amber-50 border-amber-500 ring-amber-500 bg-amber-500 focus:bg-amber-600 hover:bg-amber-600 dark:focus:ring-offset-dark-900 dark:focus:ring-amber-600 dark:hover:bg-amber-600 dark:hover:ring-amber-600 hover:border-transparent focus:ring-offset-2',
                'yellow' => 'text-yellow-50 border-yellow-500 ring-yellow-500 bg-yellow-500 focus:bg-yellow-600 hover:bg-yellow-600 dark:focus:ring-offset-dark-900 dark:focus:ring-yellow-600 dark:hover:bg-yellow-600 dark:hover:ring-yellow-600 hover:border-transparent focus:ring-offset-2',
                'lime' => 'text-lime-50 border-lime-500 ring-lime-500 bg-lime-500 focus:bg-lime-600 hover:bg-lime-600 dark:focus:ring-offset-dark-900 dark:focus:ring-lime-600 dark:hover:bg-lime-600 dark:hover:ring-lime-600 hover:border-transparent focus:ring-offset-2',
                'green' => 'text-green-50 border-green-500 ring-green-500 bg-green-500 focus:bg-green-600 hover:bg-green-600 dark:focus:ring-offset-dark-900 dark:focus:ring-green-600 dark:hover:bg-green-600 dark:hover:ring-green-600 hover:border-transparent focus:ring-offset-2',
                'emerald' => 'text-emerald-50 border-emerald-500 ring-emerald-500 bg-emerald-500 focus:bg-emerald-600 hover:bg-emerald-600 dark:focus:ring-offset-dark-900 dark:focus:ring-emerald-600 dark:hover:bg-emerald-600 dark:hover:ring-emerald-600 hover:border-transparent focus:ring-offset-2',
                'teal' => 'text-teal-50 border-teal-500 ring-teal-500 bg-teal-500 focus:bg-teal-600 hover:bg-teal-600 dark:focus:ring-offset-dark-900 dark:focus:ring-teal-600 dark:hover:bg-teal-600 dark:hover:ring-teal-600 hover:border-transparent focus:ring-offset-2',
                'cyan' => 'text-cyan-50 border-cyan-500 ring-cyan-500 bg-cyan-500 focus:bg-cyan-600 hover:bg-cyan-600 dark:focus:ring-offset-dark-900 dark:focus:ring-cyan-600 dark:hover:bg-cyan-600 dark:hover:ring-cyan-600 hover:border-transparent focus:ring-offset-2',
                'sky' => 'text-sky-50 border-sky-500 ring-sky-500 bg-sky-500 focus:bg-sky-600 hover:bg-sky-600 dark:focus:ring-offset-dark-900 dark:focus:ring-sky-600 dark:hover:bg-sky-600 dark:hover:ring-sky-600 hover:border-transparent focus:ring-offset-2',
                'blue' => 'text-blue-50 border-blue-500 ring-blue-500 bg-blue-500 focus:bg-blue-600 hover:bg-blue-600 dark:focus:ring-offset-dark-900 dark:focus:ring-blue-600 dark:hover:bg-blue-600 dark:hover:ring-blue-600 hover:border-transparent focus:ring-offset-2',
                'indigo' => 'text-indigo-50 border-indigo-500 ring-indigo-500 bg-indigo-500 focus:bg-indigo-600 hover:bg-indigo-600 dark:focus:ring-offset-dark-900 dark:focus:ring-indigo-600 dark:hover:bg-indigo-600 dark:hover:ring-indigo-600 hover:border-transparent focus:ring-offset-2',
                'violet' => 'text-violet-50 border-violet-500 ring-violet-500 bg-violet-500 focus:bg-violet-600 hover:bg-violet-600 dark:focus:ring-offset-dark-900 dark:focus:ring-violet-600 dark:hover:bg-violet-600 dark:hover:ring-violet-600 hover:border-transparent focus:ring-offset-2',
                'purple' => 'text-purple-50 border-purple-500 ring-purple-500 bg-purple-500 focus:bg-purple-600 hover:bg-purple-600 dark:focus:ring-offset-dark-900 dark:focus:ring-purple-600 dark:hover:bg-purple-600 dark:hover:ring-purple-600 hover:border-transparent focus:ring-offset-2',
                'fuchsia' => 'text-fuchsia-50 border-fuchsia-500 ring-fuchsia-500 bg-fuchsia-500 focus:bg-fuchsia-600 hover:bg-fuchsia-600 dark:focus:ring-offset-dark-900 dark:focus:ring-fuchsia-600 dark:hover:bg-fuchsia-600 dark:hover:ring-fuchsia-600 hover:border-transparent focus:ring-offset-2',
                'pink' => 'text-pink-50 border-pink-500 ring-pink-500 bg-pink-500 focus:bg-pink-600 hover:bg-pink-600 dark:focus:ring-offset-dark-900 dark:focus:ring-pink-600 dark:hover:bg-pink-600 dark:hover:ring-pink-600 hover:border-transparent focus:ring-offset-2',
                'rose' => 'text-rose-50 border-rose-500 ring-rose-500 bg-rose-500 focus:bg-rose-600 hover:bg-rose-600 dark:focus:ring-offset-dark-900 dark:focus:ring-rose-600 dark:hover:bg-rose-600 dark:hover:ring-rose-600 hover:border-transparent focus:ring-offset-2',
            ],
            'outline' => [
            ...
            'light' => [
                ...
                'slate' => 'text-slate-600 border-slate-300 ring-slate-400 bg-slate-300 focus:bg-slate-400 hover:bg-slate-400 dark:focus:ring-offset-dark-900 dark:focus:ring-slate-600 dark:hover:ring-slate-600 hover:border-transparent focus:ring-offset-2',
                'gray' => 'text-gray-600 border-gray-300 ring-gray-400 bg-gray-300 focus:bg-gray-400 hover:bg-gray-400 dark:focus:ring-offset-dark-900 dark:focus:ring-gray-600 dark:hover:ring-gray-600 hover:border-transparent focus:ring-offset-2',
                'zinc' => 'text-zinc-600 border-zinc-300 ring-zinc-400 bg-zinc-300 focus:bg-zinc-400 hover:bg-zinc-400 dark:focus:ring-offset-dark-900 dark:focus:ring-zinc-600 dark:hover:ring-zinc-600 hover:border-transparent focus:ring-offset-2',
                'neutral' => 'text-neutral-600 border-neutral-300 ring-neutral-400 bg-neutral-300 focus:bg-neutral-400 hover:bg-neutral-400 dark:focus:ring-offset-dark-900 dark:focus:ring-neutral-600 dark:hover:ring-neutral-600 hover:border-transparent focus:ring-offset-2',
                'stone' => 'text-stone-600 border-stone-300 ring-stone-400 bg-stone-300 focus:bg-stone-400 hover:bg-stone-400 dark:focus:ring-offset-dark-900 dark:focus:ring-stone-600 dark:hover:ring-stone-600 hover:border-transparent focus:ring-offset-2',
                'red' => 'text-red-600 border-red-300 ring-red-400 bg-red-300 focus:bg-red-400 hover:bg-red-400 dark:focus:ring-offset-dark-900 dark:focus:ring-red-600 dark:hover:ring-red-600 hover:border-transparent focus:ring-offset-2',
                'orange' => 'text-orange-600 border-orange-300 ring-orange-400 bg-orange-300 focus:bg-orange-400 hover:bg-orange-400 dark:focus:ring-offset-dark-900 dark:focus:ring-orange-600 dark:hover:ring-orange-600 hover:border-transparent focus:ring-offset-2',
                'amber' => 'text-amber-600 border-amber-300 ring-amber-400 bg-amber-300 focus:bg-amber-400 hover:bg-amber-400 dark:focus:ring-offset-dark-900 dark:focus:ring-amber-600 dark:hover:ring-amber-600 hover:border-transparent focus:ring-offset-2',
                'yellow' => 'text-yellow-600 border-yellow-300 ring-yellow-400 bg-yellow-300 focus:bg-yellow-400 hover:bg-yellow-400 dark:focus:ring-offset-dark-900 dark:focus:ring-yellow-600 dark:hover:ring-yellow-600 hover:border-transparent focus:ring-offset-2',
                'lime' => 'text-lime-600 border-lime-300 ring-lime-400 bg-lime-300 focus:bg-lime-400 hover:bg-lime-400 dark:focus:ring-offset-dark-900 dark:focus:ring-lime-600 dark:hover:ring-lime-600 hover:border-transparent focus:ring-offset-2',
                'green' => 'text-green-600 border-green-300 ring-green-400 bg-green-300 focus:bg-green-400 hover:bg-green-400 dark:focus:ring-offset-dark-900 dark:focus:ring-green-600 dark:hover:ring-green-600 hover:border-transparent focus:ring-offset-2',
                'emerald' => 'text-emerald-600 border-emerald-300 ring-emerald-400 bg-emerald-300 focus:bg-emerald-400 hover:bg-emerald-400 dark:focus:ring-offset-dark-900 dark:focus:ring-emerald-600 dark:hover:ring-emerald-600 hover:border-transparent focus:ring-offset-2',
                'teal' => 'text-teal-600 border-teal-300 ring-teal-400 bg-teal-300 focus:bg-teal-400 hover:bg-teal-400 dark:focus:ring-offset-dark-900 dark:focus:ring-teal-600 dark:hover:ring-teal-600 hover:border-transparent focus:ring-offset-2',
                'cyan' => 'text-cyan-600 border-cyan-300 ring-cyan-400 bg-cyan-300 focus:bg-cyan-400 hover:bg-cyan-400 dark:focus:ring-offset-dark-900 dark:focus:ring-cyan-600 dark:hover:ring-cyan-600 hover:border-transparent focus:ring-offset-2',
                'sky' => 'text-sky-600 border-sky-300 ring-sky-400 bg-sky-300 focus:bg-sky-400 hover:bg-sky-400 dark:focus:ring-offset-dark-900 dark:focus:ring-sky-600 dark:hover:ring-sky-600 hover:border-transparent focus:ring-offset-2',
                'blue' => 'text-blue-600 border-blue-300 ring-blue-400 bg-blue-300 focus:bg-blue-400 hover:bg-blue-400 dark:focus:ring-offset-dark-900 dark:focus:ring-blue-600 dark:hover:ring-blue-600 hover:border-transparent focus:ring-offset-2',
                'indigo' => 'text-indigo-600 border-indigo-300 ring-indigo-400 bg-indigo-300 focus:bg-indigo-400 hover:bg-indigo-400 dark:focus:ring-offset-dark-900 dark:focus:ring-indigo-600 dark:hover:ring-indigo-600 hover:border-transparent focus:ring-offset-2',
                'violet' => 'text-violet-600 border-violet-300 ring-violet-400 bg-violet-300 focus:bg-violet-400 hover:bg-violet-400 dark:focus:ring-offset-dark-900 dark:focus:ring-violet-600 dark:hover:ring-violet-600 hover:border-transparent focus:ring-offset-2',
                'purple' => 'text-purple-600 border-purple-300 ring-purple-400 bg-purple-300 focus:bg-purple-400 hover:bg-purple-400 dark:focus:ring-offset-dark-900 dark:focus:ring-purple-600 dark:hover:ring-purple-600 hover:border-transparent focus:ring-offset-2',
                'fuchsia' => 'text-fuchsia-600 border-fuchsia-300 ring-fuchsia-400 bg-fuchsia-300 focus:bg-fuchsia-400 hover:bg-fuchsia-400 dark:focus:ring-offset-dark-900 dark:focus:ring-fuchsia-600 dark:hover:ring-fuchsia-600 hover:border-transparent focus:ring-offset-2',
                'pink' => 'text-pink-600 border-pink-300 ring-pink-400 bg-pink-300 focus:bg-pink-400 hover:bg-pink-400 dark:focus:ring-offset-dark-900 dark:focus:ring-pink-600 dark:hover:ring-pink-600 hover:border-transparent focus:ring-offset-2',
                'rose' => 'text-rose-600 border-rose-300 ring-rose-400 bg-rose-300 focus:bg-rose-400 hover:bg-rose-400 dark:focus:ring-offset-dark-900 dark:focus:ring-rose-600 dark:hover:ring-rose-600 hover:border-transparent focus:ring-offset-2',
            ],
        ];
    }
