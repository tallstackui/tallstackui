...
class BadgeColors
{
    ...
    private function text(): array
    {
        return [
            ...
            'light' => [
                'white' => 'text-black',
                'black' => 'text-black-500 dark:text-black-700',
                'primary' => 'text-primary-500 dark:text-primary-700',
                'secondary' => 'text-secondary-500 dark:text-secondary-700',
                'slate' => 'text-slate-500 dark:text-slate-700',
                'gray' => 'text-gray-500 dark:text-gray-700',
                'zinc' => 'text-zinc-500 dark:text-zinc-700',
                'neutral' => 'text-neutral-500 dark:text-neutral-700',
                'stone' => 'text-stone-500 dark:text-stone-700',
                'red' => 'text-red-500 dark:text-red-700',
                'orange' => 'text-orange-500 dark:text-orange-700',
                'amber' => 'text-amber-500 dark:text-amber-700',
                'yellow' => 'text-yellow-500 dark:text-yellow-700',
                'lime' => 'text-lime-500 dark:text-lime-700',
                'green' => 'text-green-500 dark:text-green-700',
                'emerald' => 'text-emerald-500 dark:text-emerald-700',
                'teal' => 'text-teal-500 dark:text-teal-700',
                'cyan' => 'text-cyan-500 dark:text-cyan-700',
                'sky' => 'text-sky-500 dark:text-sky-700',
                'blue' => 'text-blue-500 dark:text-blue-700',
                'indigo' => 'text-indigo-500 dark:text-indigo-700',
                'violet' => 'text-violet-500 dark:text-violet-700',
                ...
                'rose' => 'text-rose-500 dark:text-rose-700',
            ],
        ];
    }
}
