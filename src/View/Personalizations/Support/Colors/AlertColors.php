    ...
    private function background(): array
    {
        return [
            ...
            'light' => [
                ...
                'black' => 'bg-black-50 shadow-sm',
                'primary' => 'bg-primary-50 shadow-sm',
                'secondary' => 'bg-secondary-50 shadow-sm',
                'slate' => 'bg-slate-50 shadow-sm',
                'gray' => 'bg-gray-50 shadow-sm',
                'zinc' => 'bg-zinc-50 shadow-sm',
                'neutral' => 'bg-neutral-50 shadow-sm',
                'stone' => 'bg-stone-50 shadow-sm',
                'red' => 'bg-red-50 shadow-sm',
                'orange' => 'bg-orange-50 shadow-sm',
                'amber' => 'bg-amber-50 shadow-sm',
                'yellow' => 'bg-yellow-50 shadow-sm',
                'lime' => 'bg-lime-50 shadow-sm',
                'green' => 'bg-green-50 shadow-sm',
                'emerald' => 'bg-emerald-50 shadow-sm',
                'teal' => 'bg-teal-50 shadow-sm',
                'cyan' => 'bg-cyan-50 shadow-sm',
                'sky' => 'bg-sky-50 shadow-sm',
                'blue' => 'bg-blue-50 shadow-sm',
                'indigo' => 'bg-indigo-50 shadow-sm',
                'violet' => 'bg-violet-50 shadow-sm',
                'purple' => 'bg-purple-50 shadow-sm',
                'fuchsia' => 'bg-fuchsia-50 shadow-sm',
                'pink' => 'bg-pink-50 shadow-sm',
                'rose' => 'bg-rose-50 shadow-sm',
            ],
        ];
    }
