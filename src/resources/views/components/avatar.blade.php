...
@if ($presence)
    <div class="{{ $personalize['presence.base'] }}">
        @endif
        ...
        @if ($presence)
            <span @class([
            $personalize['presence.wrapper'],
            $personalize['presence.positions.' . $presencePosition],
        ])>
            @if ($pulse)
                    <span @class([
                    $personalize['presence.ping'],
                    $colors['presence'],
                ])></span>
                @endif
            <span @class([
                'relative inline-flex',
                $personalize['presence.dot'],
                $personalize['presence.sizes.' . $size],
                $colors['presence'],
            ])></span>
        </span>
        @endif
