<li class="cursor-pointer relative md:flex md:flex-1" x-on:click="selected = item.step">
    <div class="group flex w-full items-center">
        <span class="flex items-center px-6 py-4 text-sm font-medium">
            ...
            <div class="flex flex-col">
                <span class="ml-4 text-base font-bold text-primary-500 dark:text-dark-100 whitespace-nowrap" x-text="item.title"></span>
                <span class="ml-4 text-xs font-medium text-gray-500 dark:text-dark-400 whitespace-nowrap" x-text="item.description"></span>
            </div>
        </span>
    </div>
    <div x-show="item.step != steps.length" class="absolute right-0 top-0 hidden h-full w-5 md:block" aria-hidden="true">
