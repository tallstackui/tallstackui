...
<x-dynamic-component :component="$resolver('wrapper.input')" :$id :$property :$error :$label :$hint :$invalidate password>
    <div @class([
        ...
        <div @class($personalize['icon.wrapper']) x-cloak>
            <div class="cursor-pointer" x-on:click="show = !show">
                <x-dynamic-component :component="$resolver('icon')" icon="eye" :$error @class($personalize['icon.class']) x-show="!show" />
                <x-dynamic-component :component="$resolver('icon')" icon="eye-slash" :$error @class($personalize['icon.class']) x-show="show" />
            </div>
        </div>
