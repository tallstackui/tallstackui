...
>
    ...
    >
        <div
            @class([$personalize["buttons.wrapper"], "justify-between" => $centralized])
        >
            <input
                @if ($id) id="{{ $id }}" @endif
                type="number"
            ...
            />
            <button
                @if (!$attributes->get('disabled', $attributes->get('readonly', false))) x-on:click="decrement()" @endif
            ...
            <button
                @if (!$attributes->get('disabled', $attributes->get('readonly', false))) x-on:click="increment()" @endif
